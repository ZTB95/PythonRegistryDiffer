...
create_key_value_table = ('CREATE TABLE RegKeyValue ( '  # TODO: Update the table's name in the DBD
                           'id INTEGER PRIMARY KEY, '
                           'FOREIGN KEY (regKeyId) REFERENCES RegKey(id), ' # TODO: update the column name in the DBD
...
create_only_one_hkey_trigger = ("CREATE TRIGGER trg_onlyOneHKEY BEFORE INSERT "
                                 "ON HKEYs "
